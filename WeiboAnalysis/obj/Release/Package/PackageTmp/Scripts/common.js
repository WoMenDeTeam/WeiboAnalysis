...
var Config = _config.property = {
    IdolDataBase: { "newweibo": "WeiboAnjian", "host": "http://123.103.15.153:8884/" },
    ...
    VideoDataBase: { "videoHost": "http://123.103.15.153:8388/" },
...
var Common = _Common.prototype = {
    ...
    CheckUser: function () {
        $.ajax({ type: "post", url: "Handler/User.ashx", async: false, data: { 'action': 'check_user' },
