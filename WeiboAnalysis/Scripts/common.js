...
/// <reference path="jquery.min1.71.js" />

var _config = new Object;
var Config = _config.property = {
    IdolDataBase: {
        "newweibo": "", "host": "http://10.16.0.182/jsonServer/"
    }, JsonFileName: {
        "rayjson": "rayjson.json", "level": "countResult.json", "follow": "followResult.json",
...
var MenuList = {
    "首页": "Default.aspx?首页", "高级搜索": "Default.aspx?高级搜索", "舆情专题": "Default.aspx?舆情专题", "舆情分类": "Default.aspx?舆情分类", "热点分布": "Default.aspx?热点分布", "舆情趋势": "Default.aspx?舆情趋势",
    "舆情词库": "sensitive.html", "定制信息": "agent.html", "系统设置": {
        "分类训练": "training.html", "关键词训练": "cluster_train.html", "专题设置": "topic_setting.html", "定制信息管理": "AgentManage.html", "词库维护": "SensitiveWord.html",
...
var Common = _Common.prototype = {
    ...
    Config: {
        "hotmapname": "MYJOB_SAFETY_CLUSTERS", "idolhttp": "Handler/GetImage.ashx", "hotmaplist": { "总体热点图": "JOB_SAFETY_CLUSTERS" }, "sgmapname": "myjob_SG",
    ...
    ShowEditFrame: function (g_div, child_div, parent_div, close_btn) {
        ...
        var top = (elementHeight / 2 - l_height) + document.documentElement.scrollTop + "px";
        var left = (elementWidth / 2 - l_width) + document.documentElement.scrollLeft + "px";
        parentDiv.css({ "position": "absolute", "top": top, "left": left });
        // $("#" + parent_div + "_outer").css({ "top": top, "left": left })
