...
(function () {
    ...
    Agency.startPage = 1;
    //Agency.isAllWeiBo = true;
    Agency.agencyName = "";

    //Agency.weiboAnalysis.getPostJson("../Handler/WeiboEventHandler.ashx",Agency.idolCategoryquery,function(data){
    //
    //});
    ...
    //按微博发布时间排序
    Agency.byRealTime = function () {//实时微博
...
function TimeTrend(datas) {
    var data = datas.data;
    //  $("#log1").append(JSON.stringify(data));
