...
var NewIndex = _newindex.property = {
    ...
    InitWeibo: function () {
        ...
        var IdolParameter = { "display_style": 6, "act": "weiboCountent", "action": "query", "Highlight": "Terms", "characters": "300", "mindate": mind, "maxdate": maxd, "database": Config.weibodatabase, "totalresults": "True", "summary": "context", "maxresults": "5", "text": "*", "print": "all", "sort": "Date", "start": "1", "predict": "false", "isNearTime": "false", "nearTime": "0,d" };
        ...
        Lpager.Display = function (data, obj) {
            ...
            for (var item in data) {
                ...
                content.push("<a class=\"aname\" href=\"javascript:void(0);\"><b>" + unescape(row["author"]) + "：</b></a>" + unescape(row["content"]) + "");
            ...
            Common.InitMarquee("point_weibo_frame", 2, 340, 360, 2000);
    ...
    InnitBlogBbsHot: function () {
        //var itemlist = { "point_blog_frame": "MATCH{blog}:C1", "point_bbs_frame": "MATCH{bbs}:C1", "point_weibo_frame": "EMPTY{}:CONTURL" };
        ...
        for (var item in itemlist) {
            ...
            if (item == "point_yaowen_frame") {
                query_params["database"] = "NewPortal+NewBBS";
                delete query_params["text"];
            } else if (item == "point_bbs_frame") {
                query_params["database"] = "NewBBS";
            } else {
...
MyVideo = {
    playVideo: function (data) {
        ...
        $("#newsCount").html(undefined(data.data.title));
